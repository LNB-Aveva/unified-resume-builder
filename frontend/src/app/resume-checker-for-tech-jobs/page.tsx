    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-[-80px] left-1/2 -translate-x-1/2 w-[700px] h-[500px] rounded-full bg-emerald-100/40 dark:bg-emerald-900/15 blur-3xl" />
        </div>
        <div className="mx-auto max-w-4xl px-4 pt-16 pb-14 text-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-emerald-50 dark:bg-emerald-950/50 border border-emerald-100 dark:border-emerald-800 px-4 py-1.5 text-xs font-semibold text-emerald-700 dark:text-emerald-300 mb-6">
          ...
          <p className="mt-5 text-sm text-gray-500 dark:text-gray-400">9 free AI tools &mdash; keyword extractor requires no account</p>
        </div>
      </section>

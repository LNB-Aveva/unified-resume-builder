    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-[-80px] left-1/2 -translate-x-1/2 w-[700px] h-[500px] rounded-full bg-violet-100/50 dark:bg-violet-900/20 blur-3xl" />
        </div>
        <div className="mx-auto max-w-4xl px-4 pt-16 pb-14 text-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-violet-50 dark:bg-violet-950/50 border border-violet-100 dark:border-violet-800 px-4 py-1.5 text-xs font-semibold text-violet-700 dark:text-violet-300 mb-6">

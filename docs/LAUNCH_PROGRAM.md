...
- **3.6 PDF sanitization:** `_s()` called on all 28 fpdf2 `cell`/`multi_cell` user-text paths. 12 dedicated PDF sanitization tests pass. HTML template documented as non-runtime.

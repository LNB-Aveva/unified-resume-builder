...
| 8.8 Validate policy, navigation, content, and ad density before submission. | production site | PARTIAL — Code complete: original content (6 articles), legal pages, Consent Mode v2 default-denied, ads.txt live and verified. OWNER ACTIONS REMAINING: (1) Set `NEXT_PUBLIC_ADSENSE_ID=ca-pub-7869093425931175` in Vercel Production → Environment Variables (ads disabled until this is set). (2) Wait for Google AdSense site review approval (external — can take days to weeks). (3) After approval: create ad units in AdSense dashboard, provide slot IDs to Claude, Claude places `<AdUnit slot="..." />` on chosen pages. |
...
- **Verification evidence:**
  ...
  - **8.8:** See task row above — code complete, 3 owner actions remain.
